...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let entities = vec![
            (Uuid::parse_str("123e4567-e89b-12d3-a456-426614174110").unwrap(), "Pages::AdminHome", "Represents the Admin Home page."),
            (Uuid::parse_str("123e4567-e89b-12d3-a456-426614174111").unwrap(), "Pages::Dashboard", "Represents the Dashboard page."),
